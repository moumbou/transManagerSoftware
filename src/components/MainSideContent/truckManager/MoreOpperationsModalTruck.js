...
function MoreOpptionsModalTruck() {
  ...
  const modifyHandler = () => {
      dispatch(setTarget('modify_truck'))
  };

  const deleteHandler = () => {
      dispatch(setTarget('delete_truck'))
  }
  ...
  return (
    <ul
      ...
      style={{
        display: target && target === "truck_opp" ? "flex" : "none",
...
export default MoreOpptionsModalTruck;