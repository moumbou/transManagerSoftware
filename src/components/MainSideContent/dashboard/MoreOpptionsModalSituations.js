...
function MoreOpptionsModalSituations() {
  ...
  const modifyHandler = () => {
      dispatch(setTarget('modify_situation'))
  };

  const deleteHandler = () => {
      dispatch(setTarget('delete_situation'))
  }
  ...
  return (
    <ul
      ...
      style={{
        display: target && target === "situation_opp" ? "flex" : "none",
...
export default MoreOpptionsModalSituations;
